...
library ECTools {
    ...
    function isSignedBy(bytes32 _hashedMsg, string _sig, address _addr)
        public
        pure
        returns (bool)
    {
    ...
    function substring(string _str, uint256 _startIndex, uint256 _endIndex)
        public
        pure
        returns (string)
    {
...
contract SpankChainLedgerChannel {
    ...
    function consensusCloseChannel(
        ...
        require(
            Channels[_lcID].partyAddresses[0] ==
                recoverSigner(_state, _sigA)
        );
        require(
            Channels[_lcID].partyAddresses[1] ==
                recoverSigner(_state, _sigI)
        );
    ...
    function updateLCstate(
        ...
        require(
            channel.partyAddresses[0] == recoverSigner(_state, _sigA)
        );
        require(
            channel.partyAddresses[1] == recoverSigner(_state, _sigI)
        );
    ...
    function settleVC(
        ...
        require(
            virtualChannels[_vcID].partyA ==
                recoverSigner(_updateState, sigA)
        );
    ...
    function _isContained(bytes32 _hash, bytes _proof, bytes32 _root)
        internal
        pure
        returns (bool)
    {
