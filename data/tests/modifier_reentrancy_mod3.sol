...
abstract contract Bank {
    function supportsNuToken() external virtual returns (bool);
}

contract ModifierReentrancyMod3 {
    ...
    function airDrop() public hasNoBalance supportsToken {
        ...
        // after the hasNoBalance has ensured that the sender has a 0 balance
    ...
    modifier supportsToken() {
        ...
        require(Bank(msg.sender).supportsNuToken() == true);
        _;
    }
