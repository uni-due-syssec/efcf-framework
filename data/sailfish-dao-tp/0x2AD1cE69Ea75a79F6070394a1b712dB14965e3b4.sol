...
contract LINKFund {
    ...
    uint256 public constant min_required_amount = 1 ether;
    ...
    uint256 public constant max_raised_amount = 700 ether;
    ...
    address public constant sale = 0x7093128612a02e32F1C1aa44cCD7411d84EE09Ac;

    // The contract creator. Used to finalize the buying.
    address public constant creator =
        0x0b11C7acb647eCa11d510eEc4fb0c17Bfccd6498;
